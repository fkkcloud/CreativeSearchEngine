//
// This is wrapper for Search Engine API / FAROO
//
...
public class SearchObj
{
  ...
  SearchObj(String query, int len)
  {
    ...
    String strFarooAPI = String.format(
      "http://www.faroo.com/api?q=%s&start=1&length=%d&l=en&src=web&i=false&f=json&key=%s",
      this.query,
      this.len,
      this.FAROO_API_KEY);
  ...
  public void getUrls( List<String> strLs )
  {
    try 
    {
      ...
      {
        // have to get rid of comment marks
